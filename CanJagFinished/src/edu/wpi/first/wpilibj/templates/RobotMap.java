...
public class RobotMap {
    ...
    // following variables to use with your drivetrain subsystem.
     ...
     public static final int aimingMotor = 22;      // CAN ID for Jag NOT FLASHED 

     
     
     // climbing
     public static final int extendingArmsMotor = 3;// CAN ID for Jag
     ...
     public static final int loadServo = 3;          // PWM spring tension loading ramp release
